                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            <tr>
                                                ...
                                                <td><h4><?php echo $this->crud_model->seo_stat('alexa_page_load_time'); ?></h4></td>
                                            </tr>
                                            <tr>
                                                <td>Last 3 Months</td>
                         ...
                         <div class="col-md-12">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="col-sm-">
                                            <textarea placeholder="<?php echo translate('Ex. Find best products in London')?>" name="description" class="form-control" rows='4' ><?php echo $description; ?></textarea>
                                        </div>
                                    </div>
                                </div>
